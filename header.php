...
<a href="#" data-dropdown="dropdemo" aria-controls="dropdemo" aria-expanded="false" class="button dropdown">Dropdown Button</a><br>
<ul id="dropdemo" data-dropdown-content class="f-dropdown" aria-hidden="true" tabindex="-1">
